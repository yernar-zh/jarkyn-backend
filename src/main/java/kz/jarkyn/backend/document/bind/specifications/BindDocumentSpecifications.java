...
public class BindDocumentSpecifications {
    ...
    public static Specification<BindDocumentEntity> primaryDocumentType(DocumentTypeEntity primaryDocument) {
        return (root, query, cb) -> cb.equal(root.get(BindDocumentEntity_.primaryDocument).get(DocumentEntity_.type), primaryDocument);
    }
}