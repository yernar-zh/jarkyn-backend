...
VALUES ('559109ea-f824-476d-8fa4-9990e53880ff', 'Тенге', 'KZT', '₸', now(), now()),
       ('e6a3c207-a358-47bf-ac18-2d09973f3807', 'Юань', 'CHY', '¥', now(), now()),
       ('24f15639-67da-4df4-aab4-56b85c872c3b', 'Доллар', 'USD', '$', now(), now())