...
class SaleControllerTest {
    ...
    public void testDetail_success() throws Exception {
        mockMvc.perform(get(Api.Sale.PATH + "/9f26476e-e143-4468-8a37-abdb479e89b8")
                ...
                .andExpect(jsonPath("$.paidDocuments[0].payment.currency.id").value("559109ea-f824-476d-8fa4-9990e53880ff"))
                .andExpect(jsonPath("$.paidDocuments[0].payment.currency.name").value("KZT"))
