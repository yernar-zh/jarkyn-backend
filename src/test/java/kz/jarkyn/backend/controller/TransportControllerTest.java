...
class TransportControllerTest {
    ...
    public void testDetail_parentNull() throws Exception {
        mockMvc.perform(get(Api.Transport.PATH + "/da48c6fa-6739-11ee-0a80-039b000669e2")
    ...
    public void testDetail_parentExist() throws Exception {
        mockMvc.perform(get(Api.Transport.PATH + "/cdfcf458-7cca-11ef-0a80-152f001b4886")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void testList() throws Exception {
        mockMvc.perform(get(Api.Transport.PATH).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void testCreate() throws Exception {
        ...
        mockMvc.perform(post(Api.Transport.PATH)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(requestData))
                .andExpect(status().isOk())
    ...
    public void testEdit() throws Exception {
        ...
        mockMvc.perform(put(Api.Transport.PATH + "/cdfcf458-7cca-11ef-0a80-152f001b4886")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(requestData))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").exists())
    ...
    public void testEdit_existLoop() throws Exception {
        ...
        mockMvc.perform(put(Api.Transport.PATH + "/da48c6fa-6739-11ee-0a80-039b000669e2")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(requestData))
